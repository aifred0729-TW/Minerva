...
export const snackActions = {
  success(msg, options) {
    ...
    toast(msg, {type: "success", onClick: this.dismiss, ...options});
  },
  warning(msg, options) {
    if(document.hidden){return}
    ...
    toast(<ToastComponent msg={msg} closeButton={<CloseButton/>}/>, {type: "warning", onClick: this.dismiss, ...options});
  },
  info(msg, options) {
    if(document.hidden){return}
    if(stillDoNotDisturb()){
    ...
    toast(<ToastComponent msg={msg} closeButton={<CloseButton/>}/>, {type: "info", onClick: this.dismiss, ...options});
  },
  error(msg, options) {
    if(document.hidden){return}
    toast(msg, {type: "error", onClick: this.dismiss, ...options});
  },
