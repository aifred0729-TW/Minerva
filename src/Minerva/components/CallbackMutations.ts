// ═══════════════════════════════════════════════════════════════════
//  CallbackMutations — GraphQL mutations & fragments for callbacks
//  (Minerva-native — pure GQL definitions, no components)
// ═══════════════════════════════════════════════════════════════════
...
export const updateDescriptionCallbackMutation = gql`
    mutation updateDescriptionCallback($callback_display_id: Int!, $description: String!, $color: String!) {
        updateCallback(
            input: { callback_display_id: $callback_display_id, description: $description, color: $color }
        ) {
            status
            error
        }
